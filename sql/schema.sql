...
-- ==========================================================================
-- IMAGE STORAGE (Supabase Storage bucket for menu/deal/gallery images)
-- ==========================================================================
insert into storage.buckets (id, name, public)
values ('veloura-images', 'veloura-images', true)
on conflict (id) do nothing;

create policy "Public can view veloura images" on storage.objects
  for select using (bucket_id = 'veloura-images');

create policy "Admins can upload veloura images" on storage.objects
  for insert with check (bucket_id = 'veloura-images' and public.is_admin());

create policy "Admins can update veloura images" on storage.objects
  for update using (bucket_id = 'veloura-images' and public.is_admin());

create policy "Admins can delete veloura images" on storage.objects
  for delete using (bucket_id = 'veloura-images' and public.is_admin());
